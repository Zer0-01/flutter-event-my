...
import 'package:flutter_my_event/presentation/screen/create_event/catering/widgets/catering_bottom_bar_widget.dart';
...
class _CateringScreenState extends State<CateringScreen> {
  ...
  Widget build(BuildContext context) {
    return const Scaffold(
      ...
      bottomNavigationBar: CateringBottomBarWidget(),
    );
  }
}
